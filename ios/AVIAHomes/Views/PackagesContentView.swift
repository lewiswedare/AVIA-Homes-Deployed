        ...
        ScrollView(.horizontal) {
            HStack(spacing: 8) {
                Menu {
                    ...
                    .foregroundStyle(selectedEstate != nil ? AVIATheme.aviaWhite : AVIATheme.textPrimary)
                ...
                ForEach([PackageStatus.available, .underOffer], id: \.self) { status in
                    Button {
                        ...
                        Text(status.rawValue)
                            .font(.neueCaptionMedium)
                            .foregroundStyle(selectedStatus == status ? AVIATheme.aviaWhite : AVIATheme.textPrimary)
                            .padding(.horizontal, 14)
                            .padding(.vertical, 8)
