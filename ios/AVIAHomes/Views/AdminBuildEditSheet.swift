...
struct AdminBuildEditSheet: View {
    ...
    private var selectionsSection: some View {
        VStack(spacing: 12) {
            BentoCard(cornerRadius: 16) {
                VStack(alignment: .leading, spacing: 14) {
                    HStack {
                        Label("Colour Selections", systemImage: "paintpalette.fill")
                            .font(.neueSubheadlineMedium)
                            .foregroundStyle(AVIATheme.textPrimary)
                        Spacer()
                    }

                    selectionStatusRow(section: "Exterior", categories: ["Roof", "Facade", "Cladding", "Garage Door", "Front Entry"])
                    selectionStatusRow(section: "Interior", categories: ["Benchtop", "Cabinetry", "Splashback", "Flooring", "Paint"])
                }
                .padding(16)
            }
            ...
            BentoCard(cornerRadius: 16) {
                VStack(spacing: 14) {
                    Image(systemName: "paintpalette.fill")
                        .font(.system(size: 32))
                        .foregroundStyle(AVIATheme.teal)
                    Text("Selections Status")
                        .font(.neueSubheadlineMedium)
                        .foregroundStyle(AVIATheme.textPrimary)
                    Text("Client colour and material selections are tracked here. Review and confirm all selections are finalised before each build stage.")
                        .font(.neueCaption)
                        .foregroundStyle(AVIATheme.textSecondary)
                        .multilineTextAlignment(.center)
                }
            ...
            BentoCard(cornerRadius: 16) {
                VStack(alignment: .leading, spacing: 12) {
                    Label("Specification Tier", systemImage: "crown.fill")
                        .font(.neueSubheadlineMedium)
                        .foregroundStyle(AVIATheme.textPrimary)
    ...
    private func selectionStatusRow(section: String, categories: [String]) -> some View {
